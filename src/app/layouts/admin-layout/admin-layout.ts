...
@Component({
  ...
  template: `
    <div class="flex h-screen bg-uni-950 text-uni-white font-sans overflow-hidden selection:bg-uni-500 selection:text-uni-950">
      
      <!-- ===========================
           SIDEBAR (Desktop)
           =========================== -->
      <aside class="w-72 bg-gray-900 border-r border-uni-white/5 flex flex-col z-20 hidden lg:flex relative">
        ...
        <div class="p-8 pb-4">
          <div class="flex items-center gap-3">
            ...
            <div>
              <span class="block font-uni-black text-xl tracking-tight text-uni-white leading-none">UniAdmin</span>
        ...
        <div class="p-4 border-t border-uni-white/5 bg-gray-900/50">
            ...
            <button class="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-uni-white/5 hover:bg-red-500/10 text-gray-400 hover:text-red-500 transition-all font-bold text-xs uppercase tracking-wider border border-uni-white/5 hover:border-red-500/20">
      ...
      <div class="flex-1 flex flex-col relative overflow-hidden bg-uni-950">
        ...
        <!-- Top Header (Glass) -->
        <header class="h-20 border-b border-uni-white/5 bg-gray-900/50 backdrop-blur-md flex justify-between items-center px-6 lg:px-10 relative z-20">
          ...
          <div class="flex items-center gap-4">
             <button class="relative p-2.5 rounded-full text-gray-400 hover:text-uni-white hover:bg-uni-white/5 transition-colors">
